		...
		<div class="w-[95%] h-fit bg-surface rounded-[15px] p-2 m-1">
			<section class="flex justify-between">
				<article class="text-primaryDark flex justify-center">
					<span class="material-symbols-rounded text-[28px]! mr-1"> calendar_month </span>

					<p class="text-[16px]">{{ props.dia }}/{{ props.mes }}/{{ props.ano }}</p>
				</article>
			...
			<section v-if="Show === true" class="border border-primarydark rounded-lg p-2">
				<IntensityComp Cor="warning" :intensidade="props.intensidade" class="mb-2" />
				...
				<section v-if="props.imagem" class="border-t border-primaryDark p-2">
