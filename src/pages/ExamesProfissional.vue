			...
			<div class="w-full h-full py-[1.5%] px-[2.5%] flex flex-col min-h-0">
					...
					<div class="flex flex-col items-center justify-center">
						...
						<div v-if="solicitacao === true" class="absolute inset-0 z-50 bg-black/50 w-full h-full flex justify-center place-items-center">
							<form class="bg-background w-[52%] rounded-3xl px-15 py-5 flex flex-col place-items-center relative">
								...
								<div class="relative w-full mt-3">
										...
										<select name="paciente" required class="w-full h-11 rounded-md bg-textLight text-primaryDark px-4 pl-10 appearance-none outline-none">
									...
									<div class="relative w-full h-full mt-3">
										...
										<button type="button" @click="dropExam" class="w-full h-11 bg-background text-textLight outline-none flex items-center">
									...
									<BaseButton type="submit" text="Confirmar e Solicitar Exame" class="w-full mt-2"/>
