	...
	>
		...
		>
			...
			<div class="w-1/2 box-border items-center justify-center flex flex-col">
				...
				<div class="text-[16px] text-surface">Preencha seus dados para começar.</div>
				...
				>
					...
					<input
						type="text"
						placeholder="Nome"
						class="bg-primaryBlue px-5 rounded-md w-125.75 h-11.75 flex items-center text-textlight placeholder:text-textlight outline-none"
					/>

					<!--div reservado para o cadastro do CPF-->
					<input
						v-if="status === 'Paciente'"
						type="text"
						placeholder="CPF"
						class="bg-primaryBlue px-5 rounded-md w-125.75 h-11.75 flex items-center text-textlight placeholder:text-textlight outline-none"
					/>
					...
					<div v-else class="w-125.75 h-11.75 flex flex-row">
						<input
							...
							class="bg-primaryBlue px-5 rounded-md w-116.75 h-11.75 flex items-center text-textlight placeholder:text-textlight outline-none"
						/>
					...
					<div>
						<p class="text-textlight">
							Já possuiconta? <a href="" class="text-accent">Fazer Login</a>
						</p>
					</div>
